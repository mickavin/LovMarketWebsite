...
@section('content')
   <div class="app-main__outer">
                    <div class="app-main__inner">
                            <div class="my-3">
                                    <a href="{{ route('admin.intro.index', ['commerce' => $id]) }}"><< Aller à la page du commerce</a>
                                </div>
                        <div>
                            <div>
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Formulaire d'ajout de catégorie</h5>
                                        <form action="{{ route('category.product.postcreate',['commerce' => $id]) }}" enctype="multipart/form-data" method="POST">
                                        {{ csrf_field() }}
