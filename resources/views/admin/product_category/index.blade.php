                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Liste des catégories de produits
                                            <form class="ml-auto" action="{{ route('admin.category.indexRequest', ['commerce' => $shop->id]) }}" enctype="multipart/form-data" method="POST">
                                            {{ csrf_field() }}
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a
                                                    href="{{ route('admin.category.edit', ['commerce' => $shop->id,'categorie' => $category->id ]) }}"
