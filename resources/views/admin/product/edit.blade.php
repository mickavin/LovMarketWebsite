...
@section('content')
   <div class="app-main__outer">
                    <div class="app-main__inner">
                        <div class="my-3">
                            <a href="{{ route('admin.product.index', ['commerce' => $product->shopId]) }}"><< Retour à la liste des produits</a>
                        </div>
                        <div>
                            <div>
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Formulaire de modification de produit</h5>
                                        <form action="{{ action('Admin\ProductController@update',[$shop,$product]) }}" enctype="multipart/form-data" method="POST">
                                        {{ csrf_field() }}
